...
GetFriendListResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtR1,
     {18, 63, 1, PROTOBUF_FIELD_OFFSET(GetFriendListResponse, _impl_.friend_list_)}},
    // .fixbug.ResultCode result = 1;
    {::_pbi::TcParser::FastMtS1,
    ...
    // repeated .fixbug.User friend_list = 2;
    {PROTOBUF_FIELD_OFFSET(GetFriendListResponse, _impl_.friend_list_), -1, 1, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
      {::_pbi::TcParser::GetTable<::fixbug::ResultCode>()},
...
void UserServiceRPC::GetFriendList(::google::protobuf::RpcController* PROTOBUF_NULLABLE controller,
...
void UserServiceRPC_Stub::GetFriendList(
    ::google::protobuf::RpcController* PROTOBUF_NULLABLE controller,
