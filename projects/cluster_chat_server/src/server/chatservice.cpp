...
ChatService::ChatService()
{
    ...
    _msgHandlerMap.insert(make_pair(LOGINOUT_MSG, std::bind(&ChatService::loginout, this, _1, _2, _3)));
    ...
    _msgHandlerMap.insert(make_pair(ADD_GROUP_MSG, std::bind(&ChatService::addGroup, this, _1, _2, _3)));
